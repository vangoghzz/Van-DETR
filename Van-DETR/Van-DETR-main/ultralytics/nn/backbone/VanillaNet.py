...
class GLFF1(nn.Module):
    def __init__(self, in_size, local_size=3, gamma = 2, b = 1,local_weight=0.5):
        super(GLFF1, self).__init__()
...
class GLFF2(nn.Module):
    def __init__(self, in_size, local_size=5, gamma = 2, b = 1,local_weight=0.5):
        super(GLFF2, self).__init__()
...
class GLFF3(nn.Module):
    def __init__(self, in_size, local_size=7, gamma = 2, b = 1,local_weight=0.5):
        super(GLFF3, self).__init__()
...
class VanillaNet(nn.Module):
    def __init__(self, in_chans=3, num_classes=1000, dims=[96, 192, 384, 768], 
        ...
        #self.first_two_layers = GLFF1()
        #self.third_fourth_layers = GLFF2()
        #self.last_layers = GLFF3()
